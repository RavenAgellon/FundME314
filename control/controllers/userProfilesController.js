...
// -------------------------------------------------------
async function viewAllUserProfile(req, res) {
  try {
...
// -------------------------------------------------------
// VIEW SINGLE USER PROFILE — view one profile by roleID
// -------------------------------------------------------
async function viewUserProfile(req, res) {
  try {
    // Step 1: Get the roleID from the URL
    // Example URL: /api/user-profiles/view/ROLE-001
    ...
    // Step 4: Send the profile details back to the browser
    res.json(profile);
...
module.exports = { viewAllUserProfile, viewUserProfile, searchUserProfile, createUserProfile, updateUserProfile, suspendUserProfile };