...
// -------------------------------------------------------
async function viewAllUserAccount(req, res) {
  try {
...
async function searchUserAccount(req, res) {
  try {
    ...
    // Note: userID is a Number so we try to match it directly if the search term is a number
    ...
    if (!isNaN(searchAsNumber)) {
      searchCondition.$or.push({ userID: searchAsNumber });
    }
...
module.exports = { viewAllUserAccount, viewUserAccount, searchUserAccount, createUserAccount, updateUserAccount, suspendUserAccount };